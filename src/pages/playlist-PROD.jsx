                    ...
                    return (
                        <div key={item.title} onLoad={() => {
							...
							<div className={styles.ListHead}>
								...
								<TextRegularM>Remain</TextRegularM>
								{/* <Icons.Time/> */}
							</div>
                                ...
                                {item.playlistData.map((song) => {
                                    return (
                                        <div 
                                            key={song.index} 
                                            onClick={async () => {
                                                props.changeTrack([PLAYLIST.indexOf(item), item.playlistData.indexOf(song)]);
                                                // Añade aquí la función que inicia la reproducción
