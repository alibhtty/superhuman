...
export const preLoaderAnim = () => {
  tl.to("body", {
    ...
    .to(".landing", {
      duration: 0.05,
      css: { overflowY: "hidden", height: "100vh" }, /* 90vh */
    })
    .to(".texts-container", {
      duration: 0,
      opacity: 1,
    ...
    .from(".texts-container span", {
      ...
      y: -70,
      skewY: 10,
      stagger: 0.4, /* 0,4 tiempo segundo span */
      ease: "Power3.easeOut",
    })
    .to(".texts-container span", {
      duration: .5, /* 1  tiempo out del preloader*/
      y: 70,  /* 70 ir hacia abajo */
      skewY: -20, /* -20   inclinacion out */
      stagger: 0.4,
      ease: "Power3.easeOut",
    })
    ...
    .to(
      ".preloader",
      {
        duration: .6, /* .8 slide out*/
        opacity: "0", /* heaight: "0vh"   FADE A CERO -  DESLIZAR HACIA ABAJO  */
