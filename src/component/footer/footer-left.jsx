...
import TextRegularS from '../text/text-regular-s';
...
function FooterLeft({ trackData }) {
    ...
    return (
        <div className={styles.footerLeft}>
            ...
            <Modal isVisible={modalVisible} setIsVisible={setModalVisible} content={<ModalContent trackImg={trackData.trackImg} trackName={trackData.trackName} trackArtist={trackData.trackArtist} />} />
        </div>
    );
}
