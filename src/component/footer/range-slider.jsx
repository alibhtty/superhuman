...
function RangeSlider({value, minvalue, maxvalue, handleChange}){
    ...
    const handleTouchMove = (e) => {
        ...
        const newValue = ((x / width) * (maxvalue - minvalue)) + minvalue;
        handleChange(newValue);
    };

    return (
        <div className={styles.progressBar}>
            <input ref={inputRef} type="range" onChange={handleInputChange} onTouchMove={handleTouchMove} className={styles.range__slider} min={minvalue} max={maxvalue} step="0.01" value={value} />
            <span
